...
### 2. 久留美模擬倉 (Kurumi Simulated) - 2026-03-06 13:15更新
| 股票代碼 | 名稱 | 股數 | 成本 | 狀態 |
|----------|------|------|------|------|
| 07500 | 兩倍看空 | 40,100 | $1.80 | ✅ 持有 |
| 01810 | 小米集團 | 6,200 | $32.42 | ✅ 持有 |
| 01211 | 比亞迪 | 2,100 | $97.42 | ✅ 持有 |
| 02800 | 盈富基金 | 4,500 | $27.48 | ✅ 持有 |
| 09618 | 京東集團 | 500 | $120.00 | ✅ 持有 |

**記錄：**
- **2026-03-06 13:15** Gordon買入07500 40,100股 @ $1.80 (手動落單)
- 2026-03-04 08:59 Gordon確認：久留美模擬倉由久留美自己決定買賣，唔洗逐次請示
- 2026-03-03 14:55 手動減倉（賣出過多持倉）
- 2026-03-03 12:xx 系統自動買入
- 07500 兩倍看空：已賣出
- 00700 騰訊：已止損

**系統狀態：**
- auto_trade_executor: **待設置cron** (嘗試失敗)
- crontab -e 手動添加: `35 9,11,13,15 * * 1-5 ... auto_trade_executor.py`
- 頻率: 每日4次 (9:35, 11:35, 13:35, 15:35)
...
## 2026-02-24
- **MT5 Docker設置失敗**: 嘗試本地Mac同VPS，最後因為VPS磁盤空間同資源限制失敗
- **VPS登錄資訊**: IP 167.179.95.128, 密碼 g1P}S9hH9(k[%e,m
- **00700止損**: 已完成
- **XGBoost Cron**: 正常運作
